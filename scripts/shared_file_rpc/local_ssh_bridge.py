...
Run this on the local machine. The browser or frontend sends requests to this
HTTP server, which exchanges request and response JSON files with the remote
machine over SSH.
"""
...
def main() -> int:
    ...
    parser.add_argument("--port", type=int, default=24577)
    ...
    parser.add_argument(
        ...
        default=True,
        help="Delete response files after returning them (default: enabled).",
    )
